...
```{r communal-models3}
    emmeans(communalism_m1, pairwise ~  anger_express | harm_target * prot_gender)    
...
```{r communal-visuals-sjPlot, fig.align='center', fig.width=5}
    ...
    #third research question
    plot_model(communalism_m1, type = "pred", terms = c("harm_target", "anger_express", "prot_gender"),
                    title = "Outcome: Communalism",
                     axis.title = c("Target of Harm", "Rating of Communalism"),
                    legend.title = "Anger Expressed",
                    axis.lim = c(1,5)) +
...
#research question 1  
  ...
  com_rq1 <-  ggplot(
                ...
                theme_bw() + 
                ggtitle("Communalism") +
                labs(y="Rating of Protagonist's Communalism", x = "Target of Harm", color = "Anger Expressed") +
...
#research question 3
     ...
     #interaction plot - dot-whiskers and line plot
      ...
      #ggsave('communalism_rq1.png',dpi=600) #this code will save a high resolution version of the figure
